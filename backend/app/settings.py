...
SECRET_KEY = 'django-insecure-y-@^x71e&i-su_!0=-lax8_p85w!9sgj*-vxeoo_j0t&+img14'
...
INSTALLED_APPS = [
    ...
    'app',  # Certifique-se de que isso esteja aqui
    'rest_framework',
    'gemini_api', 
    'corsheaders',
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'staticfiles', 'templates'),  # Caminho correto
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
